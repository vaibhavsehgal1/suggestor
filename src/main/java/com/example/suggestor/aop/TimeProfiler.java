...
public class TimeProfiler {
	...
	public Object profile(ProceedingJoinPoint pjp) throws Throwable {
		...
		long elapsedTimeInMilliseconds = TimeUnit.MILLISECONDS.convert(elapsedTimeInNanoSeconds,
				TimeUnit.NANOSECONDS);

		logger.debug("Method execution time of : " + pjp.getSignature() + +elapsedTimeInMilliseconds
				+ " milliseconds.");
